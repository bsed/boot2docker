...
ENV KERNEL_VERSION  4.16.1
ENV AUFS_BRANCH     aufs3.16

# Fetch the kernel sources
RUN curl --retry 10 https://www.kernel.org/pub/linux/kernel/v4.x/linux-$KERNEL_VERSION.tar.xz | tar -C / -xJ && \
...
ENV ROOTFS          /rootfs
ENV TCL_REPO_BASE   http://tinycorelinux.net/11.x/x86
